...
func (c *PoolCollector) Collect(ch chan<- prometheus.Metric) {
	...
	if err != nil {
		...
		logger.Warn("Failed to get statistics for pools")
	} else {
		...
		logger.Debug("Successfully fetched statistics for pools")
	}
	...
	logger.Debug("Getting pool statistics", "duration", elapsed)
}
